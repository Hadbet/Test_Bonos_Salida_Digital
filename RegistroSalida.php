		...
		<div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
			...
			<div class="offcanvas-body">
				<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
					<li class="nav-item">
						<a class="nav-link active" aria-current="page" href="https://arketipo.mx/Controlling/BonoSalida/RegistroSalida.php">Inicio</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="https://arketipo.mx/Controlling/BonoSalida/Historico.php">Historico</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<div id="main">
		...
		<div id='registroConcluido' style='display:none;'>
			<section id="firsts" class="main special">
				...
				<p style='padding: 4%;'>Se ha validado correctamente este registro, favor de esperar a la confirmación de su encargado que le llegara mediante correo, en dado caso que no reciba respuesta, checarlo con su encargado y si no recibió ningún correo, ponerse en contacto directo con IT</p>
		...
		<div id='registroFallido' style='display:none;'>
			<section id="firsts" class="main special">
				...
				<a style='margin-bottom: 10%;margin-top: -2%;' id="guardarRegistro" onclick='recarge();' class="btn btnRed">Regresar</a>
			</section>
		</div>
		...
		<section id="first" class="main special">
			...
			<p>Ingresa los datos correspondientes del activo que sacaras de Grammer recuerda ser muy específico con lo que ingresas y sobre todo no dejar campos vacíos.</p>
			<p>Recuerda que es importante ingresar a tu gerente en la casilla que dice "correo de tu encargado", puedes ingresar un proxy de tu gerente como un coordinador o supervisor, <span style='color:red;'>solo en caso de que no se encuentre presente tu gerente.</span></p>
				...
				<div class="row">
					...
					<div class="col-12">
						<select id="sltTipo" style="margin-bottom: 15px; margin-top: 30px;">
							...
							<option value="O-Salidas de material (Retorno a proveedor)_C">Salidas de material (Retorno a proveedor)</option>
							<option value="E-Moldes/herramentales_M">Moldes/herramentales</option>
							<option value="E-Reparaciones a maquinas, equipos y componentes_M">Reparaciones a maquinas, equipos y componentes</option>
							<option value="O-Salida de refacciones/equipos por garantía_M">Salida de refacciones/equipos por garantía</option>
							<option value="O-Rediseño y/o modificación de herramientas y maquinados._M">Rediseño y/o modificación de herramientas y maquinados.</option>
							<option value="O-Equipo/refacción de muestra para fabricación._M">Equipo/refacción de muestra para fabricación.</option>
							<option value="O-Tanques vacios para rellenar mezcla soldadura y nitrogeno_M">Tanques vacios
								para rellenar mezcla soldadura y nitrogeno</option>
							<option value="E-Residuos de equipo inutilizado (ventiladores, motores, bombas, cilindros neumáticos,etc.)_M">Residuos de equipo inutilizado (ventiladores, motores, bombas, cilindros neumáticos,etc.)</option>
							<option value="O-Componantes de materia prima, muestras, prototipos_I">Componantes de
								materia prima, muestras, prototipos</option>
							<option value="E-Subprocesos de materia prima dentro de SAP (en fase de lanzamientos)_I">
								Subprocesos de materia prima dentro de SAP (en fase de lanzamientos)</option>
							<option
							...
							<option value="E-Salida de materia prima/ PT para pruebas con proveedor_I">Salida de materia
								prima/ PT para pruebas con proveedor </option>
							<option value="O-Producto PT, muestras, prototipos_I">Producto PT, muestras, prototipos</option>
                            <option value="E-Reparacion de equipos computacionales o del área_T">Reparacion de equipos computacionales o del área</option>
							<option value="O-Cartuchos de tonner_T">Cartuchos de tonner</option>
							<option value="E-Equipos de cómputo para préstamo Tetla_T">Equipos de cómputo para préstamo Tetla</option>
							<option value="O-Sillas para Reparar (comedor)_R">Sillas para Reparar (comedor)</option>
							<option value="O-Equipo Mayor para reparar (comedor)_R">Equipo Mayor para reparar (comedor)</option>
							<option value="O-Hornos de Microondas a reparación (comedor)_R">Hornos de Microondas a reparación (comedor)</option>
							<option value="O-Equipo Mayor a desecho (comedor)_R">Equipo Mayor a desecho (comedor)</option>
						</select>
					...
					<div class="col-6 col-12-small">
						<p id="fech" name="fech" style="display:none; margin-bottom: 10px !important;">Fecha de Retorno</p>
						<input class="form-control input-sm" type="datetime-local" name="fechas" id="txtFechaRetorno"
							   style="display:none;" />
					</div>

					<div class="col-12">
							<textarea style="resize:none; margin-bottom: 15px; margin-top: 15px;" placeholder="Causa" rows="6" name="causa" id="txtCausa"
									  required></textarea>
					</div>
